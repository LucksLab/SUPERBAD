...
def run(protocol: protocol_api.ProtocolContext):
    ...
    for n in range(11):
        ...
        #For loop iterates through all 12 columns of the generic pcr strip plate in slot 5
        #Uses the same tips for the whole plate
        for x in range(12):
            #Sets the column index for the p20 multi channel pipette's next run
            col = pcr.columns()[x]

            #Aspirates 6uL of reagent from the current column of the Deepwell Plate in slot 4 at 19.98uL/s

...
metadata = {'apiLevel': '2.11',
            'Author': 'U.S. Army DEVCOM CBC - Jacob Mangini, Dan Phillips'}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    #Tells the robot to expect the temperature module to be in slot 6
    ...
    #Tells the robot to expect the opentrons 96 aluminum block generic pcr strip 200ul to be in slot 5
    pcr2 = tempMod2.load_labware('armadillopcrstripplate96wellclearwhitewell_96_wellplate_200ul')
    ...
    for csv_row in csv_reader:
        ...
        #P300 pipette picks up tip from the tip rack
        p300.pick_up_tip()
        ...
        curr_col = pcr2.columns()[col_index]
        ...
        #NOTE: Only use this option if dispense_height is a positive number!
        ...
        #Sets the height for the dispense step to the given rate in the csv file
        dispense_height = float(csv_row['dispense_height'])
        ...
        p300.dispense(20, curr_col[row_index].top(dispense_height))

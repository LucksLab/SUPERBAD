...
def run(protocol: protocol_api.ProtocolContext):
    ...
    for i in range(12):
        ...
        for x in range(3):
            ...
            ##Moves the end of the pipette tip to 2.4mm above the top of the current row index in the current column index of the well plate
            p20.move_to(row[i].top(z=2.4))
            ...
            #Pushes an extra amount of air through the pipette's tip to assure that any remaining droplets are expelled
            p20.blow_out()
            #Touches the tip to four sides of well A1 of the tube rack

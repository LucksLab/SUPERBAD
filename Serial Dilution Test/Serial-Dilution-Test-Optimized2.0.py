...
def run (protocol: protocol_api.ProtocolContext):
    ...
    #P300 pipette picks up a tip from the 200uL tip rack on slot 11
    p300.pick_up_tip()
    ...
    for i in range(4):
        ...
        #Aspirates 60uL from well A1 of the tube rack
        p300.aspirate(60, tubeRack['A1'])
        #Dispenses 60uL into columns 2-6 of the corning 96 well plate
        p300.dispense(60, row[1:5])
        
    #P300 pipette drops it's tip into the robot's default trash bin in slot 12
    p300.drop_tip()
